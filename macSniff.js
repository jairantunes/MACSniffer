...
//    console.log("strength: %s ", packet.signalStrength);
    console.log( Date.now() + " PWR: " + packet.payload.signalStrength + " || shost: " + packet.payload.ieee802_11Frame.shost + " || dhost: " + packet.payload.ieee802_11Frame.dhost + " || bssid: " + packet.payload.ieee802_11Frame.bssid);
//    console.log(packet);
}); 
